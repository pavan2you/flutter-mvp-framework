...
class DataAppRepoFactory extends RepositoryFactory {

  @override
  DataRepository<T,
      Local,
      Remote> newRepo<T extends DataObject, Local extends DataSource<
      DataObject>, Remote extends DataSource<DataObject>>(Type type) {
